...
with app.app_context():
    ...
    c4 = Client(first_name='Beau', last_name='Kim', age=29)
    c3 = Client(first_name='Bryn', last_name='Morris', age=27)
    c5 = Client(first_name='Calvin', last_name='Atkeson', age=23)
    c6 = Client(first_name='Cat', last_name='Morilla', age=27)
    c7 = Client(first_name='Collin', last_name='Burleigh', age=23)
    c8 = Client(first_name='Connor', last_name='Sheets', age=29)
    ...
    c12 = Client(first_name='Danielle', last_name='Zils', age=28)
    c13 = Client(first_name='David', last_name='Wolff', age=38)
    c14 = Client(first_name='Elif', last_name='Guzey', age=25)
    c15 = Client(first_name='Gehrig', last_name='Barnes', age=30)
    c16 = Client(first_name='Grace', last_name='Nieboer', age=27)
    c17 = Client(first_name='Hayden', last_name='Nault', age=29)
    c18 = Client(first_name='Jesse', last_name='Hunter', age=30)
    c19 = Client(first_name='Katelynn', last_name='Morris', age=21)
    c20 = Client(first_name='Kevin', last_name='Duggan', age=30)
    c21 = Client(first_name='Kevin', last_name='Salinas', age=26)
    c22 = Client(first_name='Kimberly', last_name='Benton', age=31)
    c23 = Client(first_name='Kyle', last_name='ONeill', age=25)
    ...
    c28 = Client(first_name='Marcus', last_name='Miller', age=28)
    c29 = Client(first_name='Mark', last_name='Coats', age=29)
    ...
    c34 = Client(first_name='Raymond', last_name='An', age=30)
    c35 = Client(first_name='Regan', last_name='Svoboda', age=23)
    c36 = Client(first_name='Robert', last_name='Hitchcock', age=36)
